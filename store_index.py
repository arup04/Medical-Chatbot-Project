...
from src.hybrid_retriever import save_cached_chunks
...
def main():
    ...
    # Cache preprocessed text chunks to local JSON file for BM25 retrieval
    save_cached_chunks(text_chunks, cache_path="Data/preprocessed_chunks.json")
